...
const Cards = ({data: {confirmed, recovered, deaths, lastUpdate}}) => {
    ...
    <div className={styles.container}>
        <Grid container spacing={3} justify='center'>
            <Grid item component={Card} xs={12} md={3} className={cx(styles.cart, styles.infected)}>
                <CardContent>
            ...
            <Grid item component={Card} xs={12} md={3} className={cx(styles.cart, styles.recovered)}>
                <CardContent>
            ...
            <Grid item component={Card} xs={12} md={3} className={cx(styles.cart, styles.deaths)}>
                <CardContent>
